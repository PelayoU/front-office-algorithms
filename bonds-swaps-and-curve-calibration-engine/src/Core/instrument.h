 ...
 * El objetivo es obligar a las clases derivadas (Bond, Swap) a implementar el metodo price() (que calcula el precio/valor actual del instrumento por descuento de flujos). 
